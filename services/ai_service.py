...
- Если диагноз ОЧЕВИДЕН (явный аппендицит, перелом, инфаркт и т.д.) - выдай 1 специалиста с высоким процентом (90-100%)
- Если диагноз ВЕРОЯТЕН, но нужна дифф.диагностика - выдай 2-3 специалистов
- Если ситуация НЕЯСНАЯ - выдай 3-5 специалистов для комплексного обследования
