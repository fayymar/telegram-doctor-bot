...
Ответь СТРОГО в JSON формате:
{
    ...
    def generate_additional_symptoms(self, main_symptoms: str, duration: str) -> list[str]:
        ...
        """
        system_prompt = """Ты опытный врач-диагност. На основе основных симптомов пациента, предложи 8-10 дополнительных симптомов для уточнения диагноза.
...
Предложи 8-10 дополнительных симптомов для уточнения."""
