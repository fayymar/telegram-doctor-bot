...
async def process_duration(message: Message, state: FSMContext):
    ...
    # ФОЛЛБЭК: Если AI не сгенерировал симптомы, используем стандартный набор
    if not additional_symptoms:
        print("DEBUG: No symptoms generated by AI, using fallback")
        additional_symptoms = [
        ...
        print(f"DEBUG: Using fallback symptoms: {additional_symptoms}")
